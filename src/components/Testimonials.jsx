...
function Testimonials() {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "WaterSave has been providing us with pure drinking water for over 2 years. Their service is punctual and water quality is consistently excellent. Highly recommended!",
      image:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "As a restaurant owner, water quality is crucial for our business. WaterSave ensures we get the best quality water with timely deliveries. Their commercial plans are very convenient.",
      image:
    ...
    },
    {
      ...
      rating: 4,
      comment:
        "Good service and reasonable prices. The emergency delivery option saved us during a family function. Water tastes fresh and pure.",
      image:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "I appreciate their eco-friendly approach. The bottles are always clean and the delivery staff is very polite. Been using their service for 3 years now.",
      image:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Excellent water quality and professional service. The AMC for our water purifier is worth every penny. Technical support is very responsive.",
      image:
  ...
  return (
    <section
      id="testimonials"
      className="relative py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-white to-blue-50 overflow-hidden"
    >
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-gray-600 text-base sm:text-lg max-w-2xl mx-auto">
            ...
            have to say about their experience with WaterSave.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 p-8 sm:p-12 relative">
            ...
            <button
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white border border-gray-300 rounded-full w-10 h-10 flex items-center justify-center text-gray-600 cursor-pointer hover:text-blue-600 hover:border-blue-600 transition-all duration-300 shadow-lg"
            >
              <FaChevronLeft />
            </button>
            <button
              onClick={nextTestimonial}
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white border border-gray-300 rounded-full w-10 h-10 flex items-center justify-center text-gray-600 hover:text-blue-600 cursor-pointer hover:border-blue-600 transition-all duration-300 shadow-lg"
            >
              <FaChevronRight />
            </button>
          </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-8 sm:p-12 text-white shadow-2xl">
            ...
            <p className="text-blue-100 text-lg mb-6 max-w-2xl mx-auto">
              Experience the difference of pure, quality water delivered right
              to your doorstep.
            </p>
