...
function Footer() {
  ...
  const handleNewsletterSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setPopup("Subscription failed. Please try again.");
      }
    } catch (error) {
      ...
      setLoading(false);
      setTimeout(() => setPopup(null), 3000); // 3 sec baad popup hide
    }
  };
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 to-blue-900 text-white overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-blue-200 text-lg max-w-xl">
                  ...
                  and water conservation insights.
                </p>
              </div>
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-semibold shadow-lg transition-all duration-300 flex items-center justify-center gap-3 whitespace-nowrap cursor-pointer"
                >
                  {loading ? (
            ...
            <div className="lg:col-span-1">
              <div className="mb-6">
                ...
                <p className="text-blue-200 mt-2 leading-relaxed">
                  Providing pure, safe, and healthy drinking water to families
                  and businesses across Dehradun since 2014.
                </p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="bg-white/10 border border-white/20 px-3 py-1 rounded-lg text-xs font-semibold">
                    UPI
                  </div>
                  <div className="bg-white/10 border border-white/20 px-3 py-1 rounded-lg text-xs font-semibold">
                    Cards
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-blue-200 text-sm text-center md:text-left">
              © {currentYear} WaterSave. All rights reserved. | Made with ❤️ in
              Dehradun
            </div>
      ...
      {popup && (
        <div className="fixed bottom-20 right-6 bg-green-600 text-white px-6 py-3 rounded-lg shadow-lg animate-bounce">
          {popup}
        </div>
      )}
