...
function Contact() {
    ...
    return (
        <section id="contact" className="relative py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-900 to-blue-900 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="text-blue-100 text-base sm:text-lg max-w-2xl mx-auto">
                        Have questions about our services? We're here to help. Get in touch with us today.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            {contactInfo.map((item, index) => (
                                ...
                                >
                                    <div className={`${item.color} w-14 h-14 rounded-2xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform duration-300`}>
                                        {item.icon}
                                    </div>
                                    <h3 className="text-white font-bold text-lg mb-2">{item.title}</h3>
                                    <p className="text-blue-100 text-lg font-semibold mb-1">{item.details}</p>
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
                        ...
                        <p className="text-blue-100 mb-8">We'll get back to you within 2 hours</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="text-white font-medium mb-2 block">Service Interested</label>
                                    <select
                                        name="service"
                            ...
                            <button
                                type="submit"
                                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3"
                            >
                                <FaPaperPlane />
                                Send Message
                            </button>
                  ...
                  {/* Map Section */}
                        <div className="mt-16 bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
                            <h3 className="text-white text-2xl font-bold mb-6 text-center">Find Us Here</h3>
                            ...
                            <div className="text-center mt-6">
                                ...
                                <p className="text-blue-100 text-sm mb-4">123 Water Street, Dehradun, Uttarakhand - 248001</p>
                                <a
